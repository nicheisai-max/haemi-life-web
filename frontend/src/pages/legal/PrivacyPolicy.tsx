            ...
            <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
                ...
                <Card className="p-6 md:p-12 space-y-10">
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">1. Introduction</h2>
                    ...
                    <section className="space-y-6">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">2. Information We Collect</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">3. How We Use Your Information</h2>
                    ...
                    <section className="space-y-6">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">4. Data Sharing and Disclosure</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">5. Data Security</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">6. Your Data Rights</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">7. Data Retention</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">8. Children's Privacy</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">9. International Data Transfers</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">10. Changes to This Policy</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-foreground border-b-2 border-primary pb-2">11. Contact Us</h2>
