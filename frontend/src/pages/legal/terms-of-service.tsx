        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <Card className="p-6 md:p-12 space-y-10">
                <section className="space-y-4">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">1. Agreement to Terms</h2>
                ...
                <section className="space-y-6">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">2. Platform Description</h2>
                ...
                <section className="space-y-6">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">3. User Accounts</h2>
                ...
                <section className="space-y-6">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">4. Medical Services and Disclaimers</h2>
                ...
                <section className="space-y-4">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">5. User Responsibilities</h2>
                ...
                <section className="space-y-6">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">6. Fees and Payments</h2>
                ...
                <section className="space-y-4">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">7. Intellectual Property</h2>
                    <div className="space-y-3">
                        <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">8. Privacy and Data Protection</h2>
                    <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">9. Limitation of Liability</h2>
                    <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">10. Termination</h2>
                ...
                <section className="space-y-4">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">11. Changes to Terms</h2>
                    <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">12. Governing Law</h2>
                    <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-h2 text-foreground border-b-2 border-primary pb-2">13. Contact Information</h2>
