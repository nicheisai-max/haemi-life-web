...
const SCHEMA_MANIFEST = {
    ...
    tableColumns: {
        ...
        doctor_patient_invites: ['id', 'doctor_id', 'token', 'invitee_name', 'invitee_phone', 'invitee_email', 'note', 'status', 'claimed_by_user_id', 'claimed_at', 'expires_at', 'created_at', 'updated_at', 'deleted_at'],
        doctor_profiles: ['id', 'user_id', 'specialization', 'license_number', 'years_of_experience', 'bio', 'consultation_fee', 'is_verified', 'profile_image', 'created_at', 'updated_at', 'can_video_consult', 'clinic_timezone'],
